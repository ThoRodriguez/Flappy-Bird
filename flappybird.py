...
def flappy(x,y,oiseau, rotate):
    """
    Fonction qui permet la rotation de l'oiseau
    ---
    Paramètres: 
    x: int 
    y: int
...
def tuyaux(tuyau,tuyau_bas,x_tuyau,y_tuyau,ecart): 
    """
    Fonction qui met en place les tuyaux et qui définit l'écart entre
    ---
    Paramètres: 
    tuyau: int 
    x_tuyau: int 
...
def creaTexte(texte, police):
    """
    Fonction qui permet de créer la taille et la couleur de la police
    """
    white = (255,255,255)
